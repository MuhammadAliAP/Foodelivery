...
const RestauranrMediumCard = ({ name, images: { logo }, time, distance, tags, }) => {
    return (
        <View style={styles.container}>
            <View>
                <Image source={{ uri: StaticImageService.getLogo(logo) }} style={styles.posterStyle} />
            </View>
...
export default RestauranrMediumCard
